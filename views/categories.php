...
$data = get_categories($order);
$employee_access = ['id','name'];
    ...
    <?php if(isset($data) && sizeof($data) > 0) { ?>
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach($data as $user){
                ...
                echo '<td class="d-flex gap-2 justify-content-center"><button class="btn btn-primary">Edit</button><button class="btn btn-danger">Delete</button></td>';
                echo '</tr>';
            }
            ?>
            </tbody>
